...
Wilq32.PhotoEffect.prototype._rotate = (function()
{
...

	{
		...
		var translatedAngle=(angle%360)* Math.PI / 180;
		...
		if(angle % 180 == 0){
			...
			width=this._img.height;
			height=this._img.width;
		}
		...
		this._cnv.rotate(translatedAngle);					  // rotate image
		this._cnv.translate(-this._img.width/2,-this._img.height/2);	  // move image to its center, so we can rotate around its center
