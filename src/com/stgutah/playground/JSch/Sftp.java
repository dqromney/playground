...
public class Sftp {
    ...
    private static String targetHost = "demo.commercialpreservation.com";
    private static int targetPort = 22;
    private static String targetUser = "lps";
    private static String targetPath = "/opt/FAS/LPS";
    private final static String IDENTITY = "/Users/dqromney/.ssh/id_dsa";
    private final static String localFolder = "/Users/dqromney/stgdev/playground";
    private final static String targetFile = "LPSIC_Sample_Load.csv";
        ...
        try {
            ...
            if (arg.length > 0) {
                ...
                host = JOptionPane.showInputDialog("Enter username@hostname",
                        String.format("%1$s@%2$s", targetUser, targetHost));
            }
